...
__all__ = [
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SRRTOffsetFromStart',
    'SGLexicalNoSpecialChars', 'SPAO_NONE', 'SPINTERFERENCE_TOOFAST',
    'SpeechCategoryVoices', 'ISpeechPhoneConverter',
    'SpeechTokenKeyUI', 'SPINTERFERENCE_LATENCY_WARNING',
    'SGSEnabled', 'SPWT_PRONUNCIATION', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SOTIsUISupported', 'SDKLLocalMachine',
    'DISPID_SpeechAudioStatus', 'DISPID_SGRSRule', 'SASRun',
    'ISpRecoCategory', 'ISpeechVoice', 'DISPID_SPIReplacements',
    'SpeechAllElements', 'SAFTCCITT_uLaw_11kHzStereo',
    'SRSEIsSpeaking', 'SPPS_RESERVED3', 'DISPID_SpeechGrammarRules',
    'DISPID_SpeechLexiconProns',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SpeechPartOfSpeech',
    'ISpeechRecognizer', 'SP_VISEME_1', 'SPEI_START_SR_STREAM',
    'DISPID_SLWsCount', 'SPAS_RUN', 'SVP_16',
    'DISPID_SpeechGrammarRule', 'DISPID_SRCVoicePurgeEvent',
    'SPRECOCONTEXTSTATUS', 'SPEI_MAX_SR',
    'DISPID_SpeechRecoContextEvents', 'SpResourceManager',
    'DISPID_SPIGetText', 'SAFTCCITT_uLaw_8kHzMono', 'SVP_4',
    'DISPID_SVEventInterests', 'DISPID_SOTId', 'DISPID_SLPsCount',
    'DISPID_SpeechPhraseReplacement', 'SITooLoud', 'SPFM_NUM_MODES',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SDKGetlongValue',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SP_VISEME_7',
    'SAFT48kHz16BitMono', 'SpeechRegistryLocalMachineRoot',
    'eLEXTYPE_PRIVATE7', 'SPEI_SOUND_END', 'SVF_None',
    'SAFTADPCM_22kHzMono', 'DISPID_SRCERecognition',
    'DISPID_SPCIdToPhone', 'ISpeechVoiceStatus', 'SpVoice',
    'SVEAllEvents', 'IInternetSecurityMgrSite',
    'DISPID_SpeechRecognizer', 'SAFT44kHz16BitMono',
    'SECFIgnoreKanaType', 'SGPronounciation',
    'DISPIDSPTSI_ActiveOffset', 'SVF_Stressed', 'SPAR_Medium',
    'ISpNotifySink', 'SpObjectToken', 'DISPID_SRGDictationSetState',
    'SpeechUserTraining', 'DISPID_SGRAddState',
    'DISPID_SOTGetDescription', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SABIEventBias', '__MIDL_IWinTypes_0009',
    'eLEXTYPE_PRIVATE19', 'SpShortcut', 'DISPID_SVEViseme',
    'DISPID_SRCRequestedUIType', 'DISPID_SVWaitUntilDone',
    'SpeechGrammarRuleStateTransitionType',
    'ISpeechObjectTokenCategory', 'SPWT_LEXICAL',
    'DISPID_SVSpeakStream', 'SpeechVisemeFeature', 'SDTProperty',
    'SpMMAudioIn', 'UINT_PTR', 'SREFalseRecognition',
    'SAFTADPCM_8kHzMono', 'SpeechEmulationCompareFlags',
    'DISPID_SABufferNotifySize', 'SVP_1', 'SPAUDIOBUFFERINFO',
    'ISpeechXMLRecoResult', 'SREPropertyStringChange', 'SVP_7',
    'SAFT48kHz8BitStereo', 'DISPID_SWFEBlockAlign', 'DISPID_SRStatus',
    'DISPID_SRCreateRecoContext', 'eLEXTYPE_LETTERTOSOUND',
    'SWTAdded', 'DISPID_SVPriority', 'DISPID_SWFEExtraData',
    'SVSFIsNotXML', 'SGRSTTWord', 'SAFTADPCM_22kHzStereo',
    'SpeechSpecialTransitionType', 'SpeechInterference',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SVEViseme',
    'DISPID_SRSetPropertyString', 'ISpPhoneticAlphabetConverter',
    'SPDKL_DefaultLocation', 'DISPID_SPRsItem', 'ISpMMSysAudio',
    'DISPID_SRSClsidEngine', 'DISPID_SRCEventInterests',
    'DISPID_SLGenerationId', 'DISPID_SLGetGenerationChange',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SOTMatchesAttributes', 'DISPID_SpeechRecoResult2',
    'ISpPhraseAlt', 'DISPID_SDKSetStringValue', 'SVP_0',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SVSInputSentencePosition',
    'SVP_2', 'DISPID_SPARecoResult', 'DISPID_SPEPronunciation',
    'ISpeechPhraseElement', 'DISPID_SpeechVoiceEvent',
    'DISPID_SGRSTPropertyId', 'SpeechVoiceEvents',
    'DISPID_SVSLastResult', 'SpStreamFormatConverter',
    'SPPS_RESERVED2', 'SP_VISEME_18', 'SASPause', 'SREAudioLevel',
    'DISPID_SOTCreateInstance', 'DISPID_SGRInitialState',
    'SAFT32kHz8BitStereo', 'DISPID_SVSLastBookmark',
    'DISPID_SDKOpenKey', 'DISPID_SVEVoiceChange',
    'DISPID_SPILanguageId', 'DISPID_SPRDisplayAttributes',
    'SAFT24kHz16BitMono', 'SPRULE', 'SITooSlow', 'DISPID_SOTRemove',
    'DISPID_SVESentenceBoundary', 'DISPID_SOTDisplayUI',
    'SAFT44kHz16BitStereo', 'DISPID_SRSetPropertyNumber',
    'DISPID_SPCPhoneToId', '_SPAUDIOSTATE',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SABIBufferSize',
    'eWORDTYPE_DELETED', 'ISpRecoResult', 'SPCT_SUB_DICTATION',
    'SAFT16kHz8BitMono', 'SpeechAudioFormatGUIDWave',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SPPEngineConfidence',
    'DISPID_SASCurrentDevicePosition', 'SP_VISEME_8',
    'SAFT24kHz8BitStereo', 'SPINTERFERENCE_NONE',
    'SAFT44kHz8BitStereo', 'SPDKL_LocalMachine',
    'ISpeechRecoResultDispatch', 'SPWORDTYPE',
    'DISPID_SpeechPhraseElements', 'DISPID_SDKDeleteValue',
    'SRSActiveAlways', 'SVEAudioLevel', 'SpPhoneticAlphabetConverter',
    'SPSNoun', 'SGLexical', 'SPRULESTATE',
    'DISPID_SPEEngineConfidence', 'DISPID_SRGRules', 'SVP_12',
    'DISPID_SRRSaveToMemory', 'DISPID_SAStatus', 'SP_VISEME_16',
    'SPPS_NotOverriden', 'SPSTREAMFORMATTYPE',
    'DISPID_SRAudioInputStream', 'SINoise',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SPIGetDisplayAttributes', 'SSTTWildcard',
    'SpSharedRecoContext', 'SPVPRI_OVER', 'SPEI_SENTENCE_BOUNDARY',
    'eLEXTYPE_PRIVATE11', 'SPRS_INACTIVE', 'SVP_15', 'IEnumString',
    '_ISpeechRecoContextEvents', 'SDTAlternates',
    'SpNotifyTranslator', 'SRCS_Enabled', 'SITooFast',
    'DISPID_SPPFirstElement', 'DISPID_SGRSTsCount',
    'ISpeechPhraseElements', 'DISPID_SPEsItem', 'ISpeechLexiconWord',
    'STCLocalServer', 'SVSFNLPSpeakPunc', 'SpAudioFormat',
    'ISpRecoContext', 'DISPID_SDKSetBinaryValue', 'SGRSTTRule',
    'eLEXTYPE_RESERVED6', 'SRESoundStart', 'SPINTERFERENCE_TOOSLOW',
    'SPCS_ENABLED', 'DISPID_SpeechCustomStream', 'SINone',
    'DISPID_SVResume', 'eLEXTYPE_PRIVATE4', 'SVP_11',
    'DISPID_SLPType', 'SVEBookmark', 'DISPID_SPRulesItem',
    'SpTextSelectionInformation', 'DISPID_SRRGetXMLErrorInfo',
    'ISpeechPhraseAlternate', 'DISPID_SRGCmdSetRuleIdState',
    'DISPID_SOTDataKey', 'SPPS_Noncontent', 'DISPID_SDKEnumValues',
    'DISPID_SAFGuid', 'SP_VISEME_6', 'DISPID_SPAs_NewEnum',
    'DISPID_SOTs_NewEnum', 'DISPID_SPRuleNumberOfElements',
    'ISpPhoneticAlphabetSelection',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SRCPause',
    'DISPID_SOTCId', 'DISPID_SRAudioInput', 'SpeechTokenValueCLSID',
    'eLEXTYPE_PRIVATE16', 'SVEStartInputStream',
    'DISPID_SGRAddResource', 'SpNullPhoneConverter', 'SPSVerb',
    'DISPID_SpeechLexiconWords', 'DISPID_SRRRecoContext',
    'SpeechTokenKeyAttributes', 'SPEI_RESERVED6',
    'DISPID_SpeechObjectTokenCategory', 'SVSFlagsAsync',
    'ISequentialStream', 'SPAUDIOSTATUS', 'SDKLDefaultLocation',
    'DISPID_SPIElements', 'DISPID_SRRAudio', 'SPCATEGORYTYPE',
    'SPPROPERTYINFO', 'SRATopLevel', 'ISpeechPhraseInfoBuilder',
    'ISpVoice', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SVAudioOutputStream', 'DISPID_SpeechVoiceStatus',
    'SPBINARYGRAMMAR', 'ISpStreamFormatConverter', 'SPCT_SLEEP',
    'SECFIgnoreCase', 'SWTDeleted', 'DISPID_SpeechVoice',
    'SPSHT_EMAIL', 'SPGRAMMARSTATE', 'ISpeechRecoResultTimes',
    'DISPID_SRCEInterference', 'SPGS_EXCLUSIVE',
    'SpeechRecoContextState', 'ISpeechDataKey',
    'DISPID_SpeechPhoneConverter', 'SPXRO_Alternates_SML',
    'SPEI_TTS_BOOKMARK', 'SPWF_INPUT', 'DISPID_SRRecognizer',
    'DISPID_SDKGetBinaryValue', 'SAFT12kHz16BitStereo',
    'DISPID_SpeechWaveFormatEx', 'SVP_14',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SRCRetainedAudioFormat',
    'SpeechBookmarkOptions', 'ISpResourceManager',
    'SpeechGrammarTagDictation', 'DISPID_SPEDisplayAttributes',
    'DISPID_SOTCSetId', 'DISPID_SRCRetainedAudio',
    'SSSPTRelativeToEnd', 'SPINTERFERENCE_NOISE', 'SP_VISEME_15',
    'SPFM_OPEN_READWRITE', 'SVEPhoneme', 'eLEXTYPE_PRIVATE1',
    'DISPID_SGRs_NewEnum', 'DISPID_SPRuleConfidence', 'SDTRule',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SRRTimes', 'SGRSTTEpsilon',
    'SPRS_ACTIVE', 'SRSInactiveWithPurge', 'SAFT22kHz16BitMono',
    'DISPID_SPRulesCount', 'SPEI_END_INPUT_STREAM', 'SPWF_SRENGINE',
    'SP_VISEME_9', 'SPPS_SuppressWord', 'SpPhoneConverter',
    'eLEXTYPE_PRIVATE15', 'DISPID_SCSBaseStream', 'SREStreamEnd',
    'eLEXTYPE_PRIVATE17', 'DISPID_SPRuleEngineConfidence',
    'SREPropertyNumChange', 'ISpeechMMSysAudio',
    'DISPID_SGRSAddSpecialTransition', 'SVSFParseSsml',
    'STSF_CommonAppData', 'STCInprocServer', 'DISPID_SRGCommit',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SGRsAdd', 'DISPID_SGRSTRule',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SASStop', 'SPFM_CREATE', 'SVP_6',
    'ISpPhrase', 'SDKLCurrentConfig', 'SPEI_MAX_TTS',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SpeechLexiconPronunciation',
    'eLEXTYPE_RESERVED9', 'eLEXTYPE_PRIVATE13',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SPPsCount',
    'DISPID_SPAStartElementInResult', 'SPBO_PAUSE',
    'DISPID_SGRSAddRuleTransition', 'SPPARTOFSPEECH', 'SASClosed',
    'SPFILEMODE', 'SPSUnknown', 'DISPID_SFSClose',
    'SpeechRetainedAudioOptions', 'SVPNormal', 'SPSMF_UPS',
    'SPAO_RETAIN_AUDIO', 'DISPID_SGRsCount', 'SINoSignal',
    'DISPID_SPRsCount', 'SREPhraseStart', 'SpObjectTokenCategory',
    'DISPID_SMSSetData', 'DISPID_SRGCmdSetRuleState',
    'ISpeechWaveFormatEx', 'SRARoot', 'SPSHORTCUTPAIRLIST',
    'DISPID_SpeechObjectToken', 'DISPID_SpeechMemoryStream',
    'SAFTText', 'SpeechDisplayAttributes', 'SPSHT_NotOverriden',
    'SVSFPersistXML', 'SPSNotOverriden', 'SpeechCategoryAudioOut',
    'eLEXTYPE_PRIVATE14', 'SVSFUnusedFlags',
    'DISPID_SpeechXMLRecoResult', 'ISpeechPhraseAlternates',
    'DISPID_SPANumberOfElementsInResult', 'SPEVENTENUM',
    'SpeechMicTraining', 'SPLO_STATIC',
    'DISPID_SRCERecognitionForOtherContext', 'Speech_StreamPos_Asap',
    'DISPID_SRGetFormat', 'DISPID_SRGReset', 'DISPID_SGRSTsItem',
    'DISPID_SpeechAudioFormat', 'DISPID_SRRSpeakAudio',
    'SPCONTEXTSTATE', 'SPSModifier', 'SPCT_COMMAND',
    'SAFT8kHz8BitStereo', 'SVSFParseSapi',
    'Speech_StreamPos_RealTime', 'SpMMAudioOut', 'SRESoundEnd',
    'SGDisplay', 'ISpeechRecoContext', 'SVESentenceBoundary',
    'ISpeechLexiconWords', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SSSPTRelativeToStart', 'SpeechPropertyComplexResponseSpeed',
    'SPLEXICONTYPE', 'SPEI_MIN_TTS', 'DISPID_SPIAudioSizeTime',
    'DISPID_SAEventHandle', 'SVP_13', 'SVEEndInputStream',
    'DISPID_SRGSetTextSelection', 'DISPID_SRCEStartStream',
    'IInternetSecurityManager', 'DISPID_SVSyncronousSpeakTimeout',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SpeechRecognizerStatus',
    'ISpRecoContext2', 'DISPID_SRCCreateGrammar', 'ISpSerializeState',
    'ISpEventSource', 'SpeechGrammarWordType', 'ISpLexicon',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SpeechFileStream',
    'DISPID_SVSRunningState', 'SGRSTTWildcard',
    'DISPID_SGRsCommitAndSave', 'SpeechCategoryPhoneConverters',
    'DISPID_SRRTLength', 'ISpeechGrammarRuleStateTransitions',
    'DISPID_SPEs_NewEnum', 'DISPID_SpeechPhraseElement',
    'SPCS_DISABLED', 'DISPID_SPAsItem', 'SAFT11kHz16BitMono',
    'SpeechAudioFormatGUIDText', 'DISPID_SOTRemoveStorageFileName',
    'SpeechAudioFormatType', 'SPWORD', 'SP_VISEME_19',
    'DISPID_SPIEnginePrivateData', 'SAFTTrueSpeech_8kHz1BitMono',
    'SPPHRASEELEMENT', 'SPRST_INACTIVE', 'SGRSTTDictation',
    'SPAS_CLOSED', 'SpeechRunState', 'SPBOOKMARKOPTIONS',
    'DISPID_SPAsCount', 'SVP_19', 'DISPID_SRGCmdLoadFromMemory',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SRCEFalseRecognition',
    'DISPID_SAVolume', 'SPINTERFERENCE_TOOLOUD', 'SPEI_SOUND_START',
    'ISpeechCustomStream', 'DISPID_SPRuleParent',
    'DISPID_SASFreeBufferSpace', 'SPWORDPRONUNCIATION',
    'SPPS_Modifier', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SPINTERFERENCE_NOSIGNAL', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPIDSPTSI_SelectionLength', 'SRTEmulated',
    'SPWORDPRONOUNCEABLE', 'SAFT11kHz8BitMono',
    'SAFTNoAssignedFormat', 'SPBO_TIME_UNITS',
    'DISPID_SRGIsPronounceable', 'DISPID_SRDisplayUI',
    'ISpRecoGrammar', 'SPSEMANTICERRORINFO', 'SPEVENTSOURCEINFO',
    'SPSHORTCUTPAIR', 'DISPID_SGRSTPropertyName',
    'DISPID_SpeechObjectTokens', 'DISPID_SOTGetAttribute',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SGRsItem', 'DISPID_SOTCGetDataKey', 'SECNormalConfidence',
    'SpeechTokenIdUserLexicon', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'ISpeechLexiconPronunciations', 'SpLexicon', 'SPRST_NUM_STATES',
    'SP_VISEME_10', 'SVSFIsXML', 'SP_VISEME_3', 'SPINTERFERENCE',
    'SPVPRI_NORMAL', 'DISPIDSPTSI_SelectionOffset', 'eWORDTYPE_ADDED',
    'DISPID_SPIStartTime', 'ISpRecoGrammar2', 'ISpProperties',
    'STSF_LocalAppData', 'SPDKL_CurrentConfig',
    'ISpeechGrammarRuleStateTransition', 'SVP_17',
    'DISPID_SLAddPronunciation', 'DISPID_SDKGetStringValue',
    'SBOPause', 'SpUnCompressedLexicon', 'SPSHT_OTHER',
    'DISPID_SGRsCommit', 'eLEXTYPE_PRIVATE6', 'SAFT22kHz16BitStereo',
    'SpeechVoicePriority', 'SVP_10', 'SAFTExtendedAudioFormat',
    'SSFMOpenReadWrite', 'DISPID_SPISaveToMemory',
    'DISPID_SPPChildren', 'tagSTATSTG', 'eLEXTYPE_PRIVATE9',
    'DISPID_SPPs_NewEnum', 'DISPID_SVSPhonemeId', 'SDTPronunciation',
    'SPPHRASERULE', 'DISPID_SRCEEndStream', 'ISpeechGrammarRule',
    'SPEI_INTERFERENCE', 'SPBO_AHEAD',
    'DISPID_SRGCmdLoadFromResource', 'SpeechRuleState',
    'SpeechCategoryAudioIn', 'DISPID_SpeechDataKey',
    'DISPID_SVStatus', 'SAFTGSM610_44kHzMono', 'SPWAVEFORMATTYPE',
    'SpeechAddRemoveWord', 'SPXMLRESULTOPTIONS', 'eLEXTYPE_PRIVATE2',
    'DISPID_SASetState', 'DISPID_SpeechGrammarRuleStateTransitions',
    'SRCS_Disabled', 'DISPID_SVEEnginePrivate', 'SRSEDone',
    'SPPS_Function', 'SWPUnknownWordPronounceable',
    'eLEXTYPE_PRIVATE20', 'STCAll', 'SPLOADOPTIONS',
    'SpeechVoiceCategoryTTSRate', 'SP_VISEME_5', 'DISPID_SAFType',
    'SREAllEvents', 'SPRECOSTATE', 'DISPID_SVRate', 'SPSHORTCUTTYPE',
    'DISPID_SGRSTPropertyValue', 'SPEI_TTS_AUDIO_LEVEL',
    'eLEXTYPE_APP', 'ISpeechPhraseReplacement', 'SREStreamStart',
    'SpeechGrammarTagWildcard', 'SPGS_DISABLED', 'SPEI_HYPOTHESIS',
    'SVF_Emphasis', 'SFTInput', 'ISpeechObjectTokens',
    'SAFT8kHz8BitMono', 'DISPID_SpeechPhraseProperty',
    'ISpeechPhraseReplacements', 'SECHighConfidence',
    'ISpeechPhraseRule', 'ISpeechLexiconPronunciation',
    'DISPID_SRGState', 'SAFT44kHz8BitMono', 'DISPID_SMSADeviceId',
    'DISPID_SVVolume', 'SAFT22kHz8BitMono', 'DISPID_SWFEFormatTag',
    'eLEXTYPE_RESERVED8', 'SPAS_PAUSE', 'SPEI_START_INPUT_STREAM',
    'SpeechRecognitionType', 'SPVPRIORITY', 'SGDSActiveUserDelimited',
    'SPPS_Unknown', 'SpInprocRecognizer', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SPRuleName', 'DISPID_SAFSetWaveFormatEx', 'SAFTDefault',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SRTSMLTimeout', 'SVP_8',
    'SECFEmulateResult', 'ISpeechAudioStatus', 'ISpeechAudioFormat',
    'DISPID_SPAPhraseInfo', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SPIAudioStreamPosition',
    'DISPID_SpeechPhraseReplacements', 'tagSPPROPERTYINFO',
    'SVEPrivate', 'SP_VISEME_12', 'ISpeechPhraseRules',
    'SpeechTokenKeyFiles', 'DISPID_SPRuleId', 'SP_VISEME_0',
    'DISPID_SBSFormat', 'DISPID_SpeechRecoResult', 'SPEI_MIN_SR',
    'SRADynamic', 'SECFIgnoreWidth', 'SpeechPropertyResponseSpeed',
    'SPEI_UNDEFINED', 'SPEI_ADAPTATION', 'SPPS_Noun',
    'SAFTGSM610_22kHzMono', 'ISpRecognizer', 'eLEXTYPE_USER',
    'SAFT11kHz16BitStereo', 'DISPID_SVGetProfiles',
    'SpeechVoiceSpeakFlags', 'SPRS_ACTIVE_USER_DELIMITED',
    'SAFT32kHz16BitStereo', 'SAFTCCITT_uLaw_44kHzMono',
    'ISpeechGrammarRules', 'SpeechCategoryRecognizers',
    'SPCT_DICTATION', 'SWPUnknownWordUnpronounceable',
    'DISPID_SpeechPhraseRule', 'DISPID_SRCESoundEnd',
    'DISPID_SGRSTText', 'DISPID_SWFESamplesPerSec',
    'eLEXTYPE_PRIVATE3', 'SAFT12kHz16BitMono', 'SPEI_TTS_PRIVATE',
    'DISPID_SWFEBitsPerSample', 'DISPID_SWFEAvgBytesPerSec',
    'ISpShortcut', 'STSF_AppData', 'SVP_3', 'SpeechRecoEvents',
    'DISPID_SPACommit', 'SVSFPurgeBeforeSpeak', 'SPEI_VISEME',
    'eLEXTYPE_PRIVATE18', 'SAFTCCITT_ALaw_22kHzMono', 'SRTReSent',
    'DISPID_SVIsUISupported', 'SpeechDiscardType', 'SpFileStream',
    'DISPID_SGRId', 'DISPID_SGRClear', 'SPEI_RESERVED2',
    'DISPID_SRCESoundStart', 'DISPID_SDKDeleteKey',
    'DISPID_SRCEEnginePrivate', 'ISpeechRecoResult2',
    'eLEXTYPE_PRIVATE10', 'SpeechAudioProperties',
    'SAFT8kHz16BitMono', 'SAFTCCITT_ALaw_44kHzMono', 'SPAUDIOOPTIONS',
    'DISPID_SBSSeek', 'DISPID_SPPParent', 'DISPID_SGRAttributes',
    'SPEI_RECO_OTHER_CONTEXT', 'SPAS_STOP', 'eLEXTYPE_RESERVED4',
    'SAFTGSM610_11kHzMono', 'ISpeechPhraseProperties',
    ...
    'DISPID_SRGSetWordSequenceData', 'DISPID_SLWsItem',
    'SAFTADPCM_44kHzMono', 'SPAUDIOSTATE', 'SVPOver',
    'DISPID_SRGetRecognizers', 'SPEI_SR_BOOKMARK', 'ISpObjectToken',
    'SPSHT_Unknown', 'SPAR_Unknown', 'DISPID_SPCLangId',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SpeechAudioBufferInfo',
    'SpStream', 'SPCT_SUB_COMMAND', 'SAFTADPCM_8kHzStereo',
    'SPPS_RESERVED4', 'SpeechEngineProperties', 'DISPID_SLWs_NewEnum',
    'ISpDataKey', 'eLEXTYPE_RESERVED7', 'SpeechPropertyResourceUsage',
    'DISPID_SRGDictationUnload',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SPPsItem',
    'DISPID_SABIMinNotification', 'DISPID_SVSVisemeId',
    'SP_VISEME_21', 'SDTAudio', 'SpeechWordType',
    'ISpeechTextSelectionInformation', 'DISPID_SGRsFindRule',
    'SAFT16kHz16BitMono', 'DISPID_SPPValue', 'SPEI_RECOGNITION',
    '_RemotableHandle', 'SPRECOGNIZERSTATUS', 'SPADAPTATIONRELEVANCE',
    'SVP_5', 'SAFT32kHz8BitMono', 'DISPID_SLGetWords',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SRRGetXMLResult',
    'DISPID_SGRSTNextState', 'DISPID_SRCState', 'SSFMOpenForRead',
    'DISPID_SASNonBlockingIO', 'SRTStandard', 'SpeechLexiconType',
    'SP_VISEME_20', 'DISPID_SpeechRecoContext', 'SPVPRI_ALERT',
    'DISPID_SRProfile', 'SpeechVoiceSkipTypeSentence', 'SRAExport',
    'DISPID_SPEActualConfidence', 'DISPID_SRGId',
    'SpeechPropertyAdaptationOn', 'SPRST_ACTIVE', 'SpWaveFormatEx',
    'DISPID_SLPsItem', 'SPPHRASEPROPERTY', 'SAFT16kHz8BitStereo',
    'DISPID_SPPConfidence', 'DISPID_SDKCreateKey',
    'DISPID_SOTCDefault', 'SpeechTokenContext', 'ISpeechMemoryStream',
    'SPVISEMES', 'DISPID_SRGRecoContext', 'DISPID_SRGCmdLoadFromFile',
    'SPFM_CREATE_ALWAYS', 'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SPPName', 'DISPID_SPPNumberOfElements',
    'SPEI_WORD_BOUNDARY', 'SPSERIALIZEDPHRASE', 'ISpStreamFormat',
    'SSFMCreateForWrite', 'SPWT_DISPLAY', 'DISPID_SpeechPhraseRules',
    'SLOStatic', 'ISpRecognizer2', 'DISPID_SLPLangId',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SOTCategory',
    'SPEI_VOICE_CHANGE', 'STCInprocHandler',
    'DISPID_SRSCurrentStreamNumber', 'SpeechAudioState',
    'DISPID_SpeechPhraseAlternate', 'SREHypothesis',
    'DISPID_SADefaultFormat', 'SAFT48kHz16BitStereo',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SPRs_NewEnum',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SPIProperties',
    'DISPID_SVAudioOutput', 'DISPID_SLRemovePronunciationByPhoneIds',
    'SPDATAKEYLOCATION', 'DISPID_SRCEBookmark', 'ISpNotifySource',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'ISpGrammarBuilder',
    'SRERecognition', 'SAFT8kHz16BitStereo', 'SAFT24kHz16BitStereo',
    'SPEI_PHRASE_START', 'SBONone', 'SAFT32kHz16BitMono',
    'DISPID_SVSkip', 'SP_VISEME_17', 'DISPID_SOTsCount', 'SRAONone',
    'DISPID_SRRPhraseInfo', 'DISPID_SPRuleChildren',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SOTSetId',
    'DISPID_SRCEPhraseStart', 'SpeechFormatType', 'SVPAlert',
    'DISPID_SVSInputWordLength', 'SVSFParseMask',
    'SDA_One_Trailing_Space', 'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SDTAll',
    'SPTEXTSELECTIONINFO', 'DISPIDSPTSI', 'SPFM_OPEN_READONLY',
    'ISpStream', 'DISPID_SRCVoice', 'DISPID_SPRText',
    'DISPID_SPRNumberOfElements', 'SGDSInactive',
    'SpSharedRecognizer', 'DISPID_SLPSymbolic', 'SRTAutopause',
    'DISPID_SLPs_NewEnum', 'DISPID_SPERequiredConfidence',
    'SPLO_DYNAMIC', 'SVSFIsFilename', 'SpeechLoadOption',
    'DISPID_SLPPhoneIds', 'SpeechDataKeyLocation',
    'DISPID_SRCBookmark', 'SPWORDLIST', 'SPEI_RESERVED1',
    'SpMMAudioEnum', 'ISpeechPhraseInfo',
    'DISPID_SpeechPhraseBuilder', 'SP_VISEME_11',
    'Speech_Default_Weight', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SVEStreamStart', 'SP_VISEME_13', 'DISPID_SMSAMMHandle',
    'SPEI_SR_AUDIO_LEVEL', 'SPRST_INACTIVE_WITH_PURGE',
    'SpeechVisemeType', 'DISPID_SRGDictationLoad', 'DISPID_SLWWord',
    'SAFT12kHz8BitStereo', 'eLEXTYPE_PRIVATE8',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SAFTADPCM_44kHzStereo',
    'SREInterference', 'SpeechGrammarState', 'SPEI_RESERVED3',
    'SPEI_RESERVED5', 'SpeechRecoProfileProperties',
    'SpeechRecognizerState', 'SPEI_PHONEME',
    'DISPID_SRSCurrentStreamPosition', 'SRSActive',
    'DISPID_SPEsCount', 'DISPID_SABufferInfo', 'DISPIDSPRG',
    'SREBookmark', 'ISpNotifyTranslator',
    'DISPID_SRGetPropertyNumber', 'Speech_Max_Word_Length',
    'DISPID_SVVoice', 'SGSExclusive', 'SpCompressedLexicon',
    'DISPID_SRSNumberOfActiveRules', 'SPPS_Verb', 'SPAR_High',
    'DISPID_SPRuleFirstElement', 'DISPID_SRIsUISupported',
    'SAFTADPCM_11kHzMono', 'SP_VISEME_4', 'DISPID_SPELexicalForm',
    'SPPS_Interjection', 'DISPID_SPIEngineId', 'SP_VISEME_2',
    'SPBO_NONE', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SGRSTransitions', 'SLTApp', 'DISPID_SRCEHypothesis',
    'SAFTADPCM_11kHzStereo', 'DISPID_SVEStreamEnd',
    'DISPID_SRGCmdLoadFromObject', 'ISpeechResourceLoader',
    'DISPID_SpeechPhraseInfo', 'SREPrivate', 'DISPID_SVAlertBoundary',
    'SVP_18', 'SAFTNonStandardFormat', 'ISpeechAudio',
    'SpeechWordPronounceable', 'SpeechDictationTopicSpelling',
    'eLEXTYPE_MORPHOLOGY', 'SpInProcRecoContext', 'IStream',
    'ISpeechAudioBufferInfo', 'DISPID_SDKSetLongValue',
    'DISPID_SVSInputWordPosition',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SPDKL_CurrentUser',
    'SPGS_ENABLED', 'DISPID_SVSpeak', 'SPSInterjection',
    'ISpeechObjectToken', 'SVEWordBoundary', 'eLEXTYPE_USER_SHORTCUT',
    'SPSERIALIZEDRESULT', 'DISPID_SRCERequestUI',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SRRTStreamTime',
    'DISPID_SpeechPhraseProperties', 'SAFT24kHz8BitMono',
    'DISPID_SWFEChannels', 'SPSEMANTICFORMAT', 'DISPID_SGRSTType',
    'SDA_Two_Trailing_Spaces', 'ISpPhoneConverter',
    'DISPID_SpeechRecoResultTimes',
    'SpeechPropertyLowConfidenceThreshold', 'SAFT48kHz8BitMono',
    'DISPID_SVDisplayUI', 'DISPID_SpeechLexiconWord',
    'DISPID_SGRSAddWordTransition', 'DISPID_SGRSTWeight',
    'ISpeechFileStream', 'SRERequestUI', 'ISpeechRecoGrammar',
    'DISPID_SVEAudioLevel', 'SAFT12kHz8BitMono', 'SPGRAMMARWORDTYPE',
    'DISPID_SLGetPronunciations', 'SPPHRASE',
    'DISPID_SVGetAudioOutputs', 'DISPID_SMSGetData',
    'SPRST_ACTIVE_ALWAYS', 'eLEXTYPE_RESERVED10', 'SVEVoiceChange',
    'LONG_PTR', 'SpeechEngineConfidence', 'DISPID_SMSALineId',
    'SpeechAudioVolume', 'SRTExtendableParse', 'DISPID_SBSRead',
    'SGSDisabled', 'SpeechRuleAttributes', 'SRAImport',
    'DISPID_SRCCreateResultFromMemory',
    'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SpeechBaseStream', 'DISPID_SLPPartOfSpeech',
    'DISPID_SpeechMMSysAudio', 'SRAORetainAudio', 'SSTTDictation',
    'SPVOICESTATUS', 'DISPID_SPIRule', 'DISPID_SRGetPropertyString',
    'STSF_FlagCreate', 'DISPIDSPTSI_ActiveLength',
    'ISpObjectTokenCategory', 'SVSFDefault', 'SpPhraseInfoBuilder',
    'SDA_No_Trailing_Space', 'SREStateChange', 'ISpeechBaseStream',
    'SRSInactive', 'SPRECORESULTTIMES', 'SPXRO_SML',
    'SAFTCCITT_ALaw_11kHzStereo', 'ISpeechGrammarRuleState',
    'DISPID_SDKEnumKeys', 'DISPID_SAFGetWaveFormatEx',
    'DISPID_SRRSetTextFeedback', 'SRERecoOtherContext',
    'DISPID_SFSOpen', 'DISPID_SOTsItem',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SREmulateRecognition',
    'DISPID_SVGetAudioInputs', 'ISpAudio', 'SPEVENT',
    'STCRemoteServer', 'DISPID_SPPId', 'SPEI_END_SR_STREAM',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SRCRecognizer',
    'DISPID_SRSAudioStatus', 'eLEXTYPE_PRIVATE12', 'SPEI_SR_PRIVATE',
    'DISPID_SLRemovePronunciation', 'DISPID_SRRAlternates',
    'DISPID_SRSSupportedLanguages', 'DISPID_SGRName',
    'DISPID_SRState', 'SAFT11kHz8BitStereo', 'ISpObjectWithToken',
    'SPPS_RESERVED1', 'ISpeechRecognizerStatus', 'SLTUser',
    'DISPID_SpeechLexicon', 'DISPID_SRCEAdaptation', 'ISpeechLexicon',
    'DISPID_SVSInputSentenceLength', 'SpMemoryStream', 'SFTSREngine',
    'DISPID_SPEAudioSizeTime', 'SpCustomStream',
    'DISPID_SPRules_NewEnum', 'SPAR_Low', 'DISPID_SPRFirstElement',
    'DISPID_SpeechAudio', 'SPSFunction', 'DISPID_SPEDisplayText',
    'SRADefaultToActive', 'SP_VISEME_14',
    'DISPID_SVSLastStreamNumberQueued', 'SREAdaptation',
    'SVSFNLPMask', 'SECFDefault', 'DISPID_SRRTTickCount',
    'SpeechRegistryUserRoot', 'DISPID_SVSLastBookmarkId',
    'DISPID_SLWType', 'SpeechStreamFileMode', 'WAVEFORMATEX',
    'SDTLexicalForm', 'DISPID_SVEBookmark', 'SVP_9',
    'SAFTCCITT_uLaw_44kHzStereo', 'SVSFParseAutodetect',
    '_ISpeechVoiceEvents', 'SDA_Consume_Leading_Spaces',
    'DISPID_SLWLangId', 'SPSLMA', 'SPEI_REQUEST_UI',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SASState', 'SVP_21', 'SPPHRASEREPLACEMENT',
    'SWPKnownWordPronounceable', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SLODynamic', 'SAFT16kHz16BitStereo', 'DISPID_SVEWord',
    'SDTDisplayText', 'SDTReplacement', 'SECLowConfidence',
    'DISPID_SRCSetAdaptationData', 'SpeechCategoryRecoProfiles',
    'SGRSTTTextBuffer', 'SAFTCCITT_ALaw_8kHzMono',
    'SAFTGSM610_8kHzMono', 'DISPID_SRCEAudioLevel',
    'Speech_Max_Pron_Length', 'SVP_20', 'IEnumSpObjectTokens',
    'DISPID_SLWPronunciations', 'SPEI_FALSE_RECOGNITION',
    'SGDSActive', 'SECFNoSpecialChars',
    'DISPID_SRCEPropertyNumberChange', 'ISpeechPhraseProperty',
    'DISPID_SRCResume', 'SAFTCCITT_uLaw_22kHzMono',
    'SpeechStreamSeekPositionType', 'DISPID_SGRsDynamic',
    'ISpRecognizer3', 'DISPID_SBSWrite', 'DISPID_SRIsShared',
    'DISPID_SGRSTs_NewEnum', 'ISpEventSink',
    'SpeechCategoryAppLexicons', 'SSFMCreate',
    'DISPID_SRCCmdMaxAlternates', 'ISpeechRecoResult',
    'eLEXTYPE_PRIVATE5', 'SITooQuiet', 'SPSSuppressWord',
    'SDKLCurrentUser', 'DISPID_SPIGrammarId', 'DISPID_SRRAudioFormat',
    'DISPID_SOTGetStorageFileName', 'SRAInterpreter',
    'SSTTTextBuffer', 'DISPID_SVEPhoneme', 'DISPID_SVPause',
    'ISpXMLRecoResult', 'tagSPTEXTSELECTIONINFO', 'SPPS_LMA',
